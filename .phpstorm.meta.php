...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/programming/Laravel/ponpes-absensi-be/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/programming/Laravel/ponpes-absensi-be/public/storage',
...
'instance.location.default','instance.location.list','attendance.list','attendance.check-in','attendance.check-out','storage.local',);
